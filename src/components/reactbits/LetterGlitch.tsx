...
const LetterGlitch = ({
  glitchColors = ['#3F51B5', '#00BCD4', '#7986CB', '#212121'],
  glitchSpeed = 50,
  ...
  return (
    <div className="relative w-full h-full overflow-hidden" style={{ backgroundColor: '#0a0a0a' }}>
      ...
      {outerVignette && (
        <div className="absolute top-0 left-0 w-full h-full pointer-events-none" style={{ background: 'radial-gradient(circle, transparent 20%, #0a0a0a 80%)' }} />
      )}
      {centerVignette && (
